...
const LeaveApplication = () => {
  ...
  const [employee_id, setemployee_id] = useState(nm.employee_id);
  ...
  const [manager_id, setmanager_id] = useState(nm.manager.manager_id)




  useEffect(() => {
    fetch("http://localhost:8080/getmanager?manager_id=" + nm.manager.m_id)
      .then(r => r.json())
      .then(d => setmanager(d))
  }, []);
